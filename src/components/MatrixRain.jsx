...
const ElderFurthark = 'ᚨᛒᚲᛞᛖᚠᚷᚺᛁᛃᚲᛚᛗᚾᛟᛈᚲᚱᛊᛏᚢᚢᚹXᛁᛉ';
const alpha = `abcdefghijklmnopqrstuvwxyz0123456789$+-*/=%"'#&_(),.;:?!|{}<>[]^~`;

const VALID_CHARS = alpha;
...
const MAX_DELAY_BETWEEN_STREAMS = 6000;
  ...
  return (
    <div
      style={{
        ...
        textShadow: '0px 0px 8px rgba(44, 23, 101, 0.8)',
        fontSize: 50,
      }}
    >
      {stream.map((char, index) => (
        <a
          style={{
            ...
            color: index === stream.length - 1 ? '#B4D0E7' : undefined,
            textShadow:
